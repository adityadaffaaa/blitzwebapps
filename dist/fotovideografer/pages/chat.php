...
<head>
  ...
  <title>Blitz | Foto dan Videografer</title>
  <link rel="stylesheet" href="/dist/customer/output.css" />
  ...
  <nav id="nav"
    ...
    <div class="ml-[26px] flex flex-col gap-4">
      ...
      <a href="./signin.html"
        ...
        <p id="menu-desc"
          class="text-paragraph1 absolute left-[60px] transition-default opacity-100 group-hover/nav:opacity-100">Log
          Out</p>
      </a>
    </div>
  </nav>
      ...
      <div class="flex flex-col gap-8">
        <div class="flex flex-row bg-text2 px-6 py-1 items-center justify-between shadow-default">
          <div class="flex flex-col">
            <h3 class="text-text1 text-heading3 font-poppins">Chat Admin</h3>
          </div>
          <a href="./signin.html"
        ...
        <div class="flex flex-col bg-background1 shadow-default rounded-lg mx-1 border-2 border-primary">
          <div class="flex flex-row px-6 py-4 items-center justify-between border-b-2 border-primary">
            <h5 class="text-text1 text-heading5 font-poppins">Chat Admin</h5>
          </div>
            ...
            <div class="flex flex-col px-6 py-4 h-[406px] gap-6 overflow-auto custom-scrollbar">
                  ...
                  <div class="flex flex-col gap-2">
                    <div class="p-6 bg-background1 rounded-lg shadow-default">
                      <p class="text-text1 text-paragraph4">
                        Selamat siang, Admin Blitz! Saya ingin pesan jasa fotografi untuk acara wisuda kuliah saya di
                        Oxford. Apakah Blitz bisa menyediakan fotografer yang bisa saya angkut ke Oxford ya? xixii trims
                        yhhhh
                      </p>
                    </div>
                    <div class="flex flex-row justify-start">
                      <p class="text-text3 text-paragraph4">11.20</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="flex flex-row justify-end">
                <div class="flex flex-row w-1/2 justify-end gap-3">
                  <div class="flex flex-col gap-2">
                    <div class="p-6 bg-background1 rounded-lg shadow-default">
                      <p class="text-text1 text-paragraph4">Halo Kak!</p>
                    </div>
                    <div class="flex flex-row justify-end">
                      <p class="text-text3 text-paragraph4">11.20</p>
                    </div>
                  </div>
                  <img class="h-14 rounded-full" src="../../admin/assets/img/fotoadmin.png" alt="" />
                </div>
              </div>
              <!-- chat admin end -->
              <!-- chat customer -->
              ...
              <div class="flex flex-row justify-end">
                <div class="flex flex-row w-1/2 justify-end gap-3">
                  <div class="flex flex-col gap-2">
                    <div class="p-6 bg-background1 rounded-lg shadow-default">
                      <p class="text-text1 text-paragraph4">Nanti gini ya kak</p>
                    </div>
                    <div class="flex flex-row justify-end">
                      <p class="text-text3 text-paragraph4">11.20</p>
                    </div>
