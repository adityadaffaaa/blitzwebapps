      ...
      <div class="flex flex-col bg-background1 shadow-default rounded-lg mx-1 border-2 border-primary">
        ...
        <div class="px-6 py-2 flex flex-col items-start h-[506px] overflow-auto custom-scrollbar">
          <?php 
            ...
            $sql_chat = "SELECT `cust`.`id_customer`, `cust`.`foto`, `cust`.`nama`,  DATE_FORMAT(`c`.`waktu`,'%Y-%m-%d')
          ...
          <a href="index.php?include=detail-chat-customer&data=<?php echo $id_customer ?>"
            ...
            <?php }else{ 
            ?>
            <img class="h-16 w-16 rounded-full" src="../customer/assets/img/<?php echo $foto ?>" alt="" />
            <?php }?>
