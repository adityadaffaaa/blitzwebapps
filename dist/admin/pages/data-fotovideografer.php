                  ...
                  <tr class="baris border-b-[1px] border-b-text3">
                    ...
                    <td class="h-full py-4 px-4">
                      <div class="flex flex-row  gap-2">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $nama; ?>?'))window.location.href='index.php?include=data-customer&aksi=hapus&data=<?php echo $id_fotovideografer;?>&notif=hapusberhasil'"
