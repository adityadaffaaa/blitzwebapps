                  ...
                  <tr class="baris border-b-[1px] border-b-text3">
                    ...
                    <td class="h-full py-4 px-4">
                      <div class="flex flex-row  gap-2">
                        <a href="index.php?include=detail-fotovideografer&data=<?php echo $id_fotovideografer ?>"
                          class="hapus fill-primary cursor-pointer">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $nama; ?>?'))window.location.href='index.php?include=data-fotovideografer&aksi=hapus&data=<?php echo $id_fotovideografer;?>&notif=hapusberhasil'"
...
?>
                <ul class="flex flex-row items-center gap-2">
                  <?php if($jum_halaman==0){
                      ...
                      echo "<a  href='index.php?include=data-fotovideografer&halaman=$sebelum' class='inline-block p-[4px] bg-secondary rounded-full transition-default hover:bg-primary'>
                    ...
                    // echo" <li>
                    //     <a href='index.php?include=data-fotovideografer&halaman=1'>
                    //       <div
                    ...
                    for($i=1; $i<=$jum_halaman; $i++){
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                        if($i!=$halaman){
                          echo" <li>
                        <a href='index.php?include=data-fotovideografer&halaman=$i'>
                          <div
                            class='flex justify-center text-text2 items-center w-9 h-9 bg-background2 hover:bg-primary rounded-lg transition-default'>
                            $i</div>
                        </a>
                      ...
                      if($halaman!=$jum_halaman){
                        echo"<a  href='index.php?include=data-fotovideografer&halaman=$setelah' class='inline-block p-[4px] bg-secondary rounded-full transition-default hover:bg-primary'>
                        <span class='fill-text2'>
                          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='32' height='32'>
                            <path fill='none' d='M0 0h24v24H0z' />
