...
for (let i = 0; i < accordion.length; i++) {
  accordion[i].addEventListener("click", () => {
    accordion[i].firstElementChild.lastElementChild.classList.toggle("rotate-180");
    accordion[i].lastElementChild.classList.toggle("h-0");
    accordion[i].lastElementChild.classList.toggle("py-6");
  });
}
