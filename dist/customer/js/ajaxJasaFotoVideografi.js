var getInputKategoriFotoVideografi = (idKategori) => {
  ...
  xhr.open("GET", "index.php?include=ajax-jasa-fotovideografi&idkategori=" + idKategori + "&tgl_mulai=" + tglMulai + "&tgl_selesai=" + tglSelesai, true);
  xhr.send();
};
