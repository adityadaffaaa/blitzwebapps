...
$sql_customer = "SELECT `nama`,`foto`,`level` FROM `customer` WHERE `id_customer` = '$id_customer'";
...
<!-- side bar -->
<nav
  class="h-[100vh] w-[86px] hover:w-[380px] group/nav py-8 transition-all ease-in-out duration-500 bg-secondary shadow-default shadow-secondary">
  <div class="ml-[26px] flex flex-col gap-4">
    <div class="flex flex-row items-center mb-6">
      <?php 
      if($foto == null){
      ?>
      <span class="fill-text2 scale-[180%]">
      ...
      ?>
      <img class="rounded-full h-7 ring-1 ring-text2 scale-[180%] transition-default"
        src="./assets/img/<?php echo $foto ?>" alt="" />
      <?php
      }
      ?>
      <div class="flex flex-col absolute left-[74px] transition-default opacity-0 group-hover/nav:opacity-100">
        <h5 class="text-text2 text-heading5 font-poppins"><?php echo $nama ?></h5>
        <p class="text-text2 text-paragraph4">Tier - <?php echo $level ?></p>
      </div>
    </div>
    <a href="index.php?include=beranda"
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">Beranda
      </p>
    </a>
    <a href="index.php?include=jasa-kami"
      class="flex flex-row gap-3 group text-[rgba(255,255,255,0.8)] hover:text-text2 transition-default group">
      <span class="fill-[rgba(255,255,255,0.8)] transition-default group-hover:fill-text2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
          <path fill="none" d="M0 0h24v24H0z" />
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">Jasa Kami
      </p>
    </a>
    <a href="index.php?include=riwayat"
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">Riwayat
      </p>
    </a>
    <a href="index.php?include=portofolio"
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">
        Portofolio</p>
    </a>
    <a href="index.php?include=ulasan"
      class="flex flex-row gap-3 group text-[rgba(255,255,255,0.8)] hover:text-text2 transition-default group">
      <span class="fill-[rgba(255,255,255,0.8)] transition-default group-hover:fill-text2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
          <path fill="none" d="M0 0h24v24H0z" />
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">Ulasan
      </p>
    </a>
    <a href="index.php?include=edit-profil"
      class="flex flex-row gap-3 group text-[rgba(255,255,255,0.8)] hover:text-text2 transition-default group">
      <span class="fill-[rgba(255,255,255,0.8)] transition-default group-hover:fill-text2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
          <path fill="none" d="M0 0h24v24H0z" />
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">Edit
        Profil</p>
    </a>
    <a href="index.php?include=ubah-password"
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">Ubah
        Password</p>
    </a>
    <a href="index.php?include=logout"
      ...
      <p class="text-paragraph1 absolute left-[60px] transition-default opacity-0 group-hover/nav:opacity-100">Log Out
      </p>
    </a>
  </div>
</nav>
