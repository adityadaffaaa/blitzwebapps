<div class="w-full h-full bg-cover" style="background-image: url('./assets/img/bg-signup.png')">
        ...
        <div class="flex flex-col gap-6 items-start">
          ...
          <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-1">
              ...
              <p class="text-text2 text-paragraph2">Sudah Memiliki Akun? <a class="text-secondary"
                  href="index.php?include=sign-in-customer">Sign In</a></p>
            </div>
            <div class="flex flex-col gap-6 w-[367px]">
              ...
              <div class="flex flex-row px-[14px] py-[10px] h-10 items-center bg-background1 rounded-lg text-text3">
                <input
                  class="w-full h-full outline-none text-text1 text-paragraph2 placeholder:text-text3 placeholder:text-paragraph2"
                  type="password" name="konfirmasi-password" id="konfirmasi-password"
